...
_config_dict = dict(
    ...
    MODEL=dict(
        ...
        TEST_WEIGHTS="/home/ubuntu/local/SGTR/playground/sgg/detr.res101.c5.one_stage_rel_tfmer/playground/sgg/detr.res101.c5.one_stage_rel_tfmer/2022-07-19_20-25-(top1)VidVRD-SGTR-dec_layer6/model_0023999.pth",
        ...
        ROI_RELATION_HEAD=dict(
            ...
            LONGTAIL_PART_DICT=[None, 'h', 't', 't', 't', 't', 't', 'b', 'b', 't', 'b', 't', 'b', 'b', 't', 't', 't', 't', 't', 't', 'b', 't', 'h', 't', 'b', 'b', 't', 't', 't', 'b', 't', 't', 't', 't', 't', 't', 't', 't', 'b', 'b', 't', 't', 't', 't', 'b', 't', 't', 't', 'b', 't', 'h', 't', 'b', 't', 'b', 'b', 't', 't', 't', 't', 't', 'b', 't', 't', 't', 'h', 'h', 't', 'b', 't', 't', 't', 't', 't', 't', 't', 'b', 't', 't', 't', 't', 't', 't', 't', 't', 'b', 't', 'b', 't', 't', 'b', 't', 't', 't', 't', 't', 'h', 'h', 't', 'b', 't', 'b', 't', 't', 't', 't', 't', 'b', 't', 't', 't', 'h', 't', 't', 't', 'b', 't', 't', 't', 'b', 't', 'b', 't', 'b', 't', 'b', 'b', 't', 't', 't', 't', 'b', 'b']
